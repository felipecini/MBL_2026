function Felipe_lev0_readcaSuite2p(dirsel, overwrite)
...
for iDir = dirsel
    ...
    dataDir       = fullfile('Z:\Cardin Lab\Felipe\2p sleep pilot\FC02B\150min_SD_02_260316\ca');
    
    inputFile    = {};
    inputFile = fullfile(dataDir, 'suite2p\plane0\Fall.mat');
    dataCa.trial{1}=[];
    ...
    F_subtracted = F_subtracted(S.iscell(:,1)==1,:);
